...
private:
	...
	POINT					m_oldMousePoint;		//前回のマウス座標
...
public:
	...
	// マウスＸ座標取得処理
	//----------------------------------
	int GetMouseAxisX() const {
		return m_MousePoint.x - m_oldMousePoint.x;
	}

	//----------------------------------
	// マウスＹ座標取得処理
	//----------------------------------
	int GetMouseAxisY() const {
		return m_MousePoint.y - m_oldMousePoint.y;
	}
	//----------------------------------
	// マウス左ボタンチェック
	//----------------------------------
